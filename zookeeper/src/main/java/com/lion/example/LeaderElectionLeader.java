...
public class LeaderElectionLeader implements Watcher {
    private static final String ZK_ADDRESS = "localhost:2181";
    private static final String LEADER_NODE = "/leader";
    private ZooKeeper zooKeeper;
    private String nodeId;

    public LeaderElectionLeader(String nodeId) {
        this.nodeId = nodeId;
    }
    ...
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        ...
        LeaderElectionLeader leaderElection = new LeaderElectionLeader(nodeId);
